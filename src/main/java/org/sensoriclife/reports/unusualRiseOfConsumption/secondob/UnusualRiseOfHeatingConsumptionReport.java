...
public class UnusualRiseOfHeatingConsumptionReport extends Configured implements Tool {

	public static MockInstance runSecondJob(MockInstance mockInstance) throws Exception {
