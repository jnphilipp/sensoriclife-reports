 ...
 * @version 0.0.1
 */
public class EmptyUnitConsumptionReport1 extends Configured implements Tool {
	@Override
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(new Configuration());
		job.setJobName(EmptyUnitConsumptionReport1.class.getName());
		...
		AccumuloOutputFormat.setDefaultTableName(job, Config.getProperty("reports.empty_consumption_report1.table_name"));
